...
BEGIN
  ...
  VALUES (
    ...
    CASE 
      WHEN NEW.email = 'agencia2b@gmail.com' THEN 'super_admin'::user_role
...
-- Inserir os dois usuários principais (eles precisarão fazer login pela primeira vez para ativar as contas)
-- Os usuários serão criados via interface de signup